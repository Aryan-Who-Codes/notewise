        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex justify-center items-center">
            <div className="p-1 sm:p-6 md:p-8 lg:p-10 max-w-md w-full">
                <div className="text-center mb-8">
                    <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl mb-3 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">Welcome Back</h1>
                    <p className="text-gray-700/80 text-lg">Continue your journey with Notewise</p>
                </div>
